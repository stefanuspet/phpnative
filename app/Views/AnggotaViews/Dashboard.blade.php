...
@section('content')
<div class="w-full">
    <h1 class="text-4xl font-bold pb-10 text-blue-950">Profile</h1>
    <div class="w-4/5 grid grid-cols-1 gap-10 mb-10">
        <div class="bg-white shadow-xl rounded-md px-12 py-14 flex justify-start gap-x-10 items-center">
            ...
            <div class="flex-grow h-full grid justify-end content-end">
                <a href="dashboard-anggota/editBio" class="px-3 py-1 hover:bg-yellow-600 bg-yellow-500  rounded-md text-white h-fit">Edit Biodata</a>
            </div>
        </div>
    </div>
</div>
