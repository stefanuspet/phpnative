    ...
    case FastRoute\Dispatcher::FOUND:
        ...
        if (is_callable($handler)) {
            ...
            if (method_exists($controller, $methodName)) {
                if (in_array($methodName, ['store', 'update', 'destroy', 'login', 'registerStore', 'registerAnggotaStore', 'registerMajelisStore', 'registerGuestAnggotaStore', 'registerGuestMajelisStore'])) {
