...
<div class="w-full">
    ...
    <div class="w-full py-5">
        ...
        <div class="bg-white shadow-xl rounded-md px-8 py-4">
            ...
            <div class="flex items-center gap-5 mb-5"> <!-- Ensure alignment is centered -->
                <!-- Image Section with margin-top 20px -->
                ...
                <div class="flex-1">
                    <table>
                        ...
                        <tr>
                            <td class="font-semibold">Dojo</td>
                            <td class="px-2">:</td>
                ...
                <div class="h-full flex justify-end gap-x-5">
                    ...
                    <div class="flex flex-col justify-center gap-5">
                        <a href="/dashboard/anggota/edit/{{$items->nid}}" class="px-3 py-1 hover:bg-yellow-600 bg-yellow-500 rounded-md text-white mt-5">Edit</a>
